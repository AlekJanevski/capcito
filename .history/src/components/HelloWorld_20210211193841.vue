  ...
  mounted() {
	...
	methods: {
		...
		sortByDescending () {
			...
			// console.log(this.companyFilteredFeed.sort((a, b) => { return b.id - a.id; }))
			return this.companyFilteredFeed.sort((a, b) => { return a.id - b.id; })
		},

		sortByAscending () {
			console.log('sorting ascending')
			return this.companyFilteredFeed.sort((a, b) => { return b.id - a.id; })
			// console.log(this.companyFilteredFeed.sort((a, b) => parseFloat(a.index) - parseFloat(b.index)))
		}
	}
}

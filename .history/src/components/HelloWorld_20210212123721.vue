			...
			<div class="flex flex-col items-start justify-start my-2">
				...
				<div class="flex items-center justify-start">
					...
					<button
						...
						type="button"
						class="px-4 py-1 m-2 text-white transition duration-500 bg-indigo-500 border border-indigo-500 rounded-md select-none ease hover:bg-indigo-600 focus:outline-none focus:shadow-outline"
					>
						Ascending
					</button>
					<button
